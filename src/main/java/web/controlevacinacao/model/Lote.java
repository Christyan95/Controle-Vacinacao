...
@IntegerAttributesRelation(attribute1 = "nroDosesDoLote",
						...
						message = "O nro de doses do lote tem que ser maior ou igual ao nro de doses atual")
public class Lote implements Serializable {
	...
	@Min(value = 1, message = "O nro de doses do lote deve ser maior ou igual a 1	")
	@Column(name = "nro_doses_do_lote")
	private Integer nroDosesDoLote;

	@PositiveOrZero(message = "O nro de doses atual deve ser positivo ou zero")
